...
/**
 * Generate the consolidated DIAGRAM-REGISTRY.md snapshot from the diagrams table.
 * Called after each daily and weekly scan, and by the register_diagram MCP tool.
 *
 * @param {import('better-sqlite3').Database} db
 * @param {string} rootDir - Absolute path to the DocuMind root directory
 * @returns {Promise<string>} Absolute path to the written snapshot file
 */
export async function generateDiagramSnapshot(db, rootDir) {
  ...
  const snapshotPath = path.join(rootDir, 'docs/diagrams/DIAGRAM-REGISTRY.md');
