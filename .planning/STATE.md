...
- 2026-07-10: ~~Buzz references + retired-study ROI claims removed from both decks~~ **CORRECTION (2026-07-11):** this removal was never committed and does NOT exist in the live decks — it survives only in stash backup ref `backup/table-lint-wip-2026-07-11`. Current working-tree/HEAD decks still contain Buzz content.
