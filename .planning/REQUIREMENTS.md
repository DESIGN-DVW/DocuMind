...
- [x] **MCPW-01**: `index_file` tool — re-index a single file after edit

- [x] **MCPW-02**: `lint_file` tool — lint a file and return issues

- [x] **MCPW-03**: `fix_file` tool — auto-fix a file's markdown issues

- [x] **MCPW-04**: `trigger_scan` tool — trigger incremental or full scan via orchestrator

- [x] **MCPW-05**: `relink_diagram` tool — set curated FigJam URL and propagate

- [x] **MCPW-06**: Path validation against `ctx.repoRoots` for all write operations
...
| MCPW-04 | Phase 5 | Complete |

| MCPW-05 | Phase 5 | Complete |

| MCPW-06 | Phase 5 | Complete |
