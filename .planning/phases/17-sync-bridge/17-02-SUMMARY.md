...
- FOUND: .planning/phases/17-sync-bridge/17-02-SUMMARY.md

- FOUND commit: d8612fc (feat: wire syncToKuzu into runDeepScan pipeline)

- FOUND commit: 5511537 (feat: scheduler/server wiring + backfill + health)
